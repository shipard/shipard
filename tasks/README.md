...
Celkem 283 tasků: **naplánováno** 4 · **částečně** 13 · **hotovo** 266.
...
| `accbal-ledger-identity-key.md` | částečně | kód, CLI, testy a docs hotové 2026-09-14 (3 commity), nasazeno a ověřeno na 4l3j; zbývá ds-upgrade → DROP INDEX → `accbal-regenerate --all` + kontrolní SELECT na e8w1-i a btpg-p (poslední bod „Hotovo když“) |
