...
/**
 * Class SumTableJournalDebsBS
 * @package e10doc\debs
 */
class SumTableJournalDebsBS extends SumTableJournalDebs
{
	public function init()
	{
		parent::init();

		$this->objectClassId = 'e10doc.debs.SumTableJournalDebsBS';
		$this->accountKinds = [2, 3];
	}
