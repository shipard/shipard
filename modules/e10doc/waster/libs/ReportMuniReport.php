...
/**
 * class ReportMuniReport
 */
class ReportMuniReport extends \e10doc\core\libs\reports\DocReportBase
{
  var $codeKindNdx = 1;
  ...
  var $periodEnd = NULL;
	...
	{
		parent::init();
		$this->setReportId('e10doc.waster.muniReport');
	...
	public function loadData ()
	{
		...
		$this->loadData_MainPerson('muniPerson');
    ...
    $this->data['wasteOriginAdmUnit'] = $this->app()->loadItem($this->recData['wasteOriginAdmUnit'], 'e10.world.admUnits');
