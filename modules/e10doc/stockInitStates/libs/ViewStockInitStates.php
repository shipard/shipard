...
class ViewStockInitStates extends \E10Doc\Core\ViewHeads
{
	var $warehouses;
	public function init ()
	{
		$this->docType = 'stockinst';
		parent::init();
	}
	...
	{
		$q [] = 'SELECT heads.[ndx] as ndx, [docNumber], [title], [sumPrice], [sumBase], [sumTotal], [toPay], [cashBoxDir], [dateIssue], [person], [currency], heads.docStateAcc,
