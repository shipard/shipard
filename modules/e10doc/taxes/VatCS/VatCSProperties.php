...
/**
 * Class VatCSProperties
 * @package e10doc\taxes\VatCS
 */
class VatCSProperties extends \e10doc\taxes\TaxReportProperties
{
	...
	public function loadProperties ($taxReportNdx, $filingNdx = 0)
	{
		$xmlConvert = [
				...
				'e10-CZ-VCS-podani' => [ // podání
						'e10-CZ-VCS-druhHlaseni' => 'khdph_forma',
						'e10-CZ-VCS-denDuvNaslPod' => 'd_zjist',
						'e10-CZ-VCS-cisJednVyzvy' => 'c_jed_vyzvy',
						'e10-CZ-VCS-rychOdpNaVyz' => 'vyzva_odp'
				]
		];
	...
	{
		$this->properties['xml']['dokument'] = 'KH1';
		...
		if (!isset($this->properties['xml']['khdph_forma']))
			$this->properties['xml']['khdph_forma'] = 'B';

		$this->properties['flags']['forma'][$this->properties['xml']['khdph_forma']] = 'X';
	}

	public function name()
	{
		$name = '';
		if (isset ($this->properties['all']['e10-CZ-VCS-podani-e10-CZ-VCS-druhHlaseni']))
			$name .= $this->properties['all']['e10-CZ-VCS-podani-e10-CZ-VCS-druhHlaseni'];
