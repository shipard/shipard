...
/**
 * Class Order
 * @package e10buy\orders\dc
 */
class Order extends \e10\DocumentCard
{
	var $dko = NULL;
	...
	public function createContentHeader ()
	{
		...
		$this->personRecData = $this->tablePersons->loadItem ($recData['supplier']);
		...
		{
			$hdr ['info'][] = ['class' => 'title', 'value' => 'Nová objednávka'];
		}
	...
	public function createContent_Rows ()
	{
		...
		array_push($q, ' WHERE [rows].[order] = %i', $this->recData ['ndx']);
