...
/**
 * @class PartnersDSEngine
 */
class PartnersDSEngine extends Utility
{
  ...
  public function setPartner($partnerNdx)
  {
    $this->partnerNdx = $partnerNdx;
  }
  ...
  function loadData()
    ...
    $this->loadDataPart([
      ...
      'query' => ['invoicingTo' => 0, 'dsType' => 0, 'dsDemo' => 0, 'condition' => 2]
    ]);
