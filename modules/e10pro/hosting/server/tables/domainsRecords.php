...
class TableDomainsRecords extends DbTable
{
	public function __construct ($dbmodel)
	{
		...
		$this->setName ('e10pro.hosting.server.domainsRecords', 'e10pro_hosting_server_domainsRecords', 'Doménové záznamy');
	}
	...
	/*
	 * 		{"id": "", "name": "Název", "type": "string", "len": 120},
		{"id": "", "name": "Hodnota", "type": "string", "len": 120},
		{"id": "", "name": "Priorita", "type": "int"},
		{"id": "", "name": "TTL", "type": "int"},
	 */
}
...
class ViewDomainsRecords extends TableView
{
	...
	public function init ()
	{
		...
		$this->domainRecordTypes = $this->app()->cfgItem('e10pro.hosting.server.domainsRecordTypes');
	...
	public function selectRows ()
	{
		...
		$q[] = 'SELECT * FROM [e10pro_hosting_server_domainsRecords] ';
