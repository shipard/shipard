...
/**
 * Class TableBulkRecipients
 * @package e10pro\wkf
 */
class TableBulkRecipients extends DbTable
{
	public function __construct ($dbmodel)
	{
		parent::__construct ($dbmodel);
		$this->setName ('e10pro.bume.bulkRecipients', 'e10pro_wkf_bulkRecipients', 'Adresáti hromadné pošty');
	}
 ...
 * @package E10Pro\newsltr
 */
class FormBulkRecipient extends TableForm
{
