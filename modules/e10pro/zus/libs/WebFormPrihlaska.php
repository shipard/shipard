...
class WebFormPrihlaska extends \Shipard\Base\WebForm
{
	...
	public function createFormCode ($options = 0)
	{
		...
		$c .= $this->addFormInput ('', 'select', 'skolniRok', ['select' => ['2026' => '2026 / 2027', '2025' => '2025 / 2026'], 'inputStyle' => 'width: 10rem; display: inline-block; margin-left: .5rem; margin-right: .5rem;']);
