 ...
 */
 ...
 class ViewPurchases extends TableView
 {
	 var $currencies;
	 var $paymentMethods;
	 var $today;
	 ...
	 public function init ()
	 {
		 ...
		 $this->uiSubTemplate = 'modules/e10pro/purchase/libs/apps/subtemplates/purchaseRow';
	 ...
	 {
		 array_push($q, ' AND [heads].[person] = %i', $this->app->userNdx());
