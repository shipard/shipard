...
/**
 * Class ServingFoodRemainingWidget
 * @package e10pro\canteen\dataView
 */
class ServingFoodRemainingWidget extends DataView
{
	var $today;
	var $canteenNdx = 1;
	var $canteen = NULL;
	...
	{
		$this->classId = 'e10pro.canteen.dataView.ServingFoodRemainingWidget';
		$this->remoteElementId = 'e10pro-canteen-ServingFoodRemainingWidget';
	...
	protected function renderDataAsWidget()
	{
		...
		$c .= "<div class='row'><div class='col-12 e10-display-panel-title e10-display-cm-panelTitle'><i class='fa fa-angle-right'></i> ".utils::es('Nevydaná jídla').'</div></div>';
