...
/**
 * Class ReportPropertyCardNonDeps
 * @package e10pro\property
 */
class ReportPropertyCardNonDeps extends FormReport
{
	function init ()
	{
		parent::init();
