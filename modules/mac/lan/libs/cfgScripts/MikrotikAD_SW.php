 ...
 * Class MikrotikAD_SW
 */
class MikrotikAD_SW extends \mac\lan\libs\cfgScripts\MikrotikAD
{
	CONST vfSW = 0, vfHW = 1;
	...
	{
    $this->scriptModeSignature = 'OLD SW MODE';

		parent::setDevice($deviceRecData, $lanCfg);

		$this->vlanFiltering = intval($this->deviceCfg['vlanFiltering'] ?? 0);
	}
