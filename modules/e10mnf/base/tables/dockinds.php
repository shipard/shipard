...
class ViewDocKinds extends TableView
{
	...
	public function renderRow ($item)
	{
		...
		if ($item['order'])
			$props[] = ['text' => utils::nf($item['order']), 'icon' => 'icon-sort', 'class' => 'pull-right label label-default'];
...
class FormDocKind extends TableForm
{
	public function renderForm ()
	{
		...
		$this->openForm ();
			$tabs ['tabs'][] = ['text' => 'Druh zakázky', 'icon' => 'x-content'];
			$tabs ['tabs'][] = ['text' => 'Nastavení', 'icon' => 'icon-wrench'];
			$tabs ['tabs'][] = ['text' => 'Detail', 'icon' => 'icon-file'];
