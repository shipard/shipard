 ...
 * class PersonDefault
 */
class PersonNew extends TableForm
{
	...
	public function renderForm ()
	{
		...
		$this->openForm ();
			...
			$tabs ['tabs'][] = ['text' => 'Banka', 'icon' => 'tables/e10doc.base.bankaccounts'];
			...
			$this->openTabs ($tabs);
				$this->openTab ();
					...
					$this->layoutOpen (TableForm::ltHorizontal);
						$this->layoutOpen (TableForm::ltVertical);
              if (isset($this->recData['ndx']) && $this->recData['ndx'])
                $this->addViewerWidget ('e10.persons.personsContacts', 'form', ['personNdx' => $this->recData['ndx']], TRUE);
						$this->layoutClose('pr1 pt1');
					$this->layoutClose();
				$this->closeTab ();
