...
<head>
	...
	function portalInfo ()
	{
		$portals = [
			'shipard.app' => [
				'pages' => [
					'help' => ['id' => 'help', 'host' => 'doc.shipard.app', 'title' => 'Návody', 'subtitle' => 'Dokumentace k Shipardu', 'icon' => 'icon-book'],
					'hp' => ['id' => 'hp', 'host' => 'shipard.cz', 'title' => 'shipard.cz', 'subtitle' => 'Naše webové stránky', 'icon' => 'icon-globe'],
				]
			],
			'shipard.cz' => [
				'pages' => [
					'help' => ['id' => 'help', 'host' => 'navody.shipard.cz', 'title' => 'Návody', 'subtitle' => 'Dokumentace k Shipardu', 'icon' => 'icon-book'],
					'support' => ['id' => 'support', 'host' => 'podpora.shipard.cz', 'title' => 'Podpora', 'subtitle' => 'Pomoc s řešením problémů', 'icon' => 'icon-comments-o'],
					'portal' => ['id' => 'portal', 'host' => 'muj.shipard.cz', 'title' => 'Můj Shipard', 'subtitle' => 'Přehled vašich databází', 'icon' => 'icon-user-circle-o'],
					'hp' => ['id' => 'hp', 'host' => 'shipard.cz', 'title' => 'shipard.cz', 'subtitle' => 'Naše webové stránky', 'icon' => 'icon-globe'],
				]
			],
			'shipard.com' => [
				'pages' => [
					'help' => ['id' => 'help', 'host' => 'help.shipard.com', 'title' => 'Návody', 'subtitle' => 'Dokumentace k Shipardu', 'icon' => 'icon-book'],
					'support' => ['id' => 'support', 'host' => 'podpora.shipard.com', 'title' => 'Podpora', 'subtitle' => 'Pomoc s řešením problémů', 'icon' => 'icon-comments-o'],
					'portal' => ['id' => 'portal', 'host' => 'me.shipard.com', 'title' => 'Můj Shipard', 'subtitle' => 'Přehled vašich databází', 'icon' => 'icon-user-circle-o'],
					'hp' => ['id' => 'hp', 'host' => 'shipard.cz', 'title' => 'shipard.cz', 'subtitle' => 'Naše webové stránky', 'icon' => 'icon-globe'],
				]
			],
			'shipard.pro' => [
				'develMode' => 1,
				'pages' => [
					'help' => ['id' => 'help', 'host' => 'docs.shipard.pro', 'title' => 'Návody', 'subtitle' => 'Dokumentace k Shipardu', 'icon' => 'icon-book'],
					'support' => ['id' => 'support', 'host' => 'talk.shipard.pro', 'title' => 'Podpora', 'subtitle' => 'Pomoc s řešením problémů', 'icon' => 'icon-comments-o'],
					'portal' => ['id' => 'portal', 'host' => 'my.shipard.pro', 'title' => 'Můj Shipard', 'subtitle' => 'Přehled vašich databází', 'icon' => 'icon-user-circle-o'],
					'hp' => ['id' => 'hp', 'host' => 'ds.shipard.pro/shipard', 'title' => 'shipard.cz', 'subtitle' => 'Naše webové stránky', 'icon' => 'icon-globe']
				],
				'social' => [
					['type' => 'tw', 'text' => 'Twitter', 'icon' => 'icon-twitter', 'url' => 'https://twitter.com/shipard_cz'],
					['type' => 'email', 'text' => 'Github', 'icon' => 'icon-github', 'url' => 'https://github.com/shipard']
				]
			],
		];
		...
		$pi = $portals['shipard.cz'];

		if (isset($portals[$activeDomain]) && isset($portals[$activeDomain]['develMode']))
		{
			$devParts = explode ('-', $hpr[2]);
			$pi = $portals[$activeDomain];
			unset ($pi['develMode']);
			foreach ($pi['pages'] as $key => &$value)
			{
				if (is_array($value) && isset($value['host']))
					$value['host'] = $devParts[0].'-'.$value['host'];
			}
		}
		else
		if (isset($portals[$activeDomain]))
		{
			$pi = $portals[$activeDomain];
			if ($activeDomain === 'shipard.pro')
				$pi['isShipard'] = 1;
		}
